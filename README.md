...
- [ ] Giai đoạn 8: Tích hợp API (VNStock / yfinance) để tự động cập nhật Giá thị trường (Live Price) theo thời gian thực.
- [ ] Giai đoạn 9: Đa dạng hóa Biểu đồ Phân tích Hiệu suất nâng cao.
