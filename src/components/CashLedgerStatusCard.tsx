  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-4 shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-sm font-bold text-slate-100">Cash Ledger</h3>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
        <div className="rounded-xl bg-slate-950/60 px-3 py-2">
          <div className="text-[11px] uppercase tracking-wide text-slate-400">Nguồn số dư</div>
          <div className="mt-1 font-semibold text-slate-100">
            {metrics.cashBalanceSource === 'ledger' ? 'Ledger' : 'Derived'}
          </div>
        </div>
        <div className="rounded-xl bg-slate-950/60 px-3 py-2">
          <div className="text-[11px] uppercase tracking-wide text-slate-400">Số dư cuối ngày</div>
          <div className="mt-1 font-semibold text-slate-100">
        ...
        <div className="rounded-xl bg-slate-950/60 px-3 py-2">
          <div className="text-[11px] uppercase tracking-wide text-slate-400">Import gần nhất</div>
          <div className="mt-1 font-semibold text-slate-100">
      ...
      {lastCashImportSummary && (
        <div className="mt-4 rounded-xl border border-slate-800 px-3 py-3 text-xs text-slate-300">
          <div className="font-medium text-slate-100">{lastCashImportSummary.fileName}</div>
          <div className="mt-1">
