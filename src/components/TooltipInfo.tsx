...
export default function TooltipInfo({ content }: { content: string }) {
  ...
  return (
    <div className="group relative ml-1.5 inline-flex shrink-0 items-center justify-center">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 z-50 w-max max-w-[min(18rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-[calc(100%+12px)] opacity-0 invisible transition-all duration-200 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100">
