...
export const i18n = {
  vi: {
    ...
    reconciliation: {
      title: 'Bang doi soat',
      subtitle: 'Tach NAV, gia von va PnL theo cac thanh phan de nhin ra phan con lech voi DNSE.',
      cashBalance: 'Tien mat',
      stockMarketValue: 'Gia tri co phieu',
      grossNavBeforeDebt: 'NAV truoc no phi',
      feeDebt: 'No phi',
      netNav: 'NAV sau no phi',
      costBasis: 'Gia von hien hanh',
      unrealizedPnL: 'Lai lo chua chot',
      avgRealizedPnL: 'Lai lo da chot AVG',
      activeStocks: 'Ma duong',
      negativeStocks: 'Ma am',
      openingPositions: 'Opening positions',
      liveCoverage: 'Live gia',
      ledgerCash: 'Cash ledger',
      derivedCash: 'Cash replay',
      cashDrift: 'Lech cash',
      insights: 'Nhan dinh',
      noInsights: 'Chua phat hien van de doi soat ro rang tu bo du lieu hien tai.',
    }
  },
  en: {
    dashboard: {
